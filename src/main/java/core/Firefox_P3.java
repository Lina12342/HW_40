...
public class Firefox_P3 {
	...
	public static void main(String[] args) throws InterruptedException, FileNotFoundException, IOException {
		Logger.getLogger("org.openqa.selenium").setLevel(Level.OFF);               // Suppress Warnings

		p.load(new FileInputStream("input.properties"));
		
		if (System.getProperty("os.name").toUpperCase().contains("MAC")) 			drivePath = "/usr/local/bin//usr/local/bin/geckodriver.sh";
